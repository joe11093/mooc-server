...
if(isset($obj["annee_id"])){
	...
	$sqlquery = "SELECT * FROM video_de_cours WHERE video_de_cours.matiere_id = '$matiere_id' AND video_de_cours.annee_id = '$annee_id' ORDER BY video_de_cours.chapitre ASC";
